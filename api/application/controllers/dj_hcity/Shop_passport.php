...
/**
 * @Author: binghe
 * @Date:   2018-07-24 12:00:01
 * @Last Modified by:   binghe
 * @Last Modified time: 2018-08-03 16:43:31
 */
 ...
 * 门店登录
 */
class Shop_passport extends dj_hcity_controller
{
    ...
    public function toggle()
    {
        ...
        if ($shopId === null) {
            $lastShopId = get_secret_cookie('c_hcity_shop_id',$this->s_user->id);
            if($lastShopId !== null)
        ...
        //设置永久cookie,成功时直接跳转
        set_secret_cookie('c_hcity_shop_id', $currentShopId, 3600 * 24 * 7,$this->s_user->id);
