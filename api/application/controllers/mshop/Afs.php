...
class Afs extends mshop_controller
{
    /**
     * 查询订单可退详情
     */
    public function availableRefund()
    {
        ...
        $result = $wmOrderDao->getOneArray(['uid' => $this->s_user->uid, 'tid' => $input['tradeno']], 'status,pay_money,pay_time,afsno');
        ...
        $result = $wmOrderExtDao->getAllArray(['uid' => $this->s_user->uid, 'tid' => $input['tradeno']], 'ext_tid,goods_title,num,pay_money');
