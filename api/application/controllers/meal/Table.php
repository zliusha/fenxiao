...
class Table extends meal_table_controller
{
    // 读取桌位信息
    public function load()
    {
        ...
        $order_table = $mealOrderTableDao->getOne(['id' => $this->table->cur_order_table_id, 'aid' => $this->aid]);
    ...
    public function setting()
    {
        ...
        if (empty($this->table->cur_order_table_id)) {
            ...
            $shop = $wmShopDao->getOne(['id' => $this->table->shop_id,'aid'=>$this->aid]);
            if (!$shop) {
