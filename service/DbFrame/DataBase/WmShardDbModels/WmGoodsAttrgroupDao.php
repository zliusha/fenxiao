 ...
 * 公司
 */
class WmGoodsAttrgroupDao extends BaseDao
{
	/**
   * 添加多规格商品属性
   * @param $data
   ...
   */
    public function addAttr($data, $goodsId=0, $aid=0)
    {
        ...
        $wmGoodsAttritemDao->delete(['goods_id'=>$goodsId]);
        ...
        foreach($data as $key => $attr)
        {
            ...
            if(!empty($item_tmp)) $wmGoodsAttritemDao->createBatch($item_tmp);
        }
        return true;
    }
}