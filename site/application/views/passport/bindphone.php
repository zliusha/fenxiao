...
<head>
  ...
  <title>云店宝绑定手机号 - 国内领先外卖新零售管理系统 外卖行业新零售解决方案 外卖开店 用云店宝！</title>
  ...
  <script>
    if(window.top != window.self){
      window.top.location = __BASEURL__ + 'passport/bindphone';
    }  
  </script>
</head>
<body>
      ...
      <div class="left_area">
        ...
        <div style="display:block;" class="form_body">
          ...
          <div style="display: block;margin-top: 40px;" class="input_item clearfix" id="finish_reg">
            <button id="btn-bindphone" type="button" class="btn btn_primary">提交</button>
          </div>
        </div>
      </div>
  ...
  <?=static_original_url('site/js/bindphone.js');?>
</body>
</html>