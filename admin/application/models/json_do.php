 ...
 * @Last Modified time: 2016-07-27 18:01:19
 */
/**
* json输出格式
*/
class json_do 
{
    ...
    //设置错误消息
    function set_error($code,$msg='',$out_put=true)
    {
        $this->code = $code;
        if(!empty($msg))
        $this->msg=$msg;
    ...
    function set_error_pre($code,$msg_pre,$out_put=true)
    {
        $this->code = $code;
        if(!empty($msg_pre))
