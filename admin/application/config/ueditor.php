...
$config['ueditor'] = [
    ...
    "imageUrlPrefix" => UPLOAD_URL, /* 图片访问路径前缀 */
    ...
    "catcherUrlPrefix" => UPLOAD_URL, /* 图片访问路径前缀 */
    ...
    "videoUrlPrefix" => UPLOAD_URL, /* 视频访问路径前缀 */
    ...
    "fileUrlPrefix" => UPLOAD_URL, /* 文件访问路径前缀 */
    ...
    "imageManagerUrlPrefix" => UPLOAD_URL, /* 图片访问路径前缀 */
    ...
    "fileManagerUrlPrefix" => UPLOAD_URL, /* 文件访问路径前缀 */
