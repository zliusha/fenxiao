...
//echo 'Retrieve from cache',PHP_EOL;
	...
	private function _parseFormula($formula, PHPExcel_Cell $pCell = NULL) {
		...
		$output = array();
		$expectingOperator = FALSE;					//	We use this tests in syntax-checking the expression to determine when a
													//		- is a negation or + is a positive operator rather than an operation
		$expectingOperand = FALSE;					//	We use this tests in syntax-checking the expression to determine whether an operand
	...
	private function _validateBinaryOperand($cellID, &$operand, &$stack) {
		...
		if (is_string($operand)) {
			...
			if (!is_numeric($operand)) {
				//	If not a numeric, tests to see if the value is an Excel error, and so can't be used in normal binary operations
