...
class PHPExcel_ReferenceHelper
{
	 ...
	 *
	 * @param   string   $a  First column to tests (e.g. 'AA')
	 * @param   string   $b  Second column to tests (e.g. 'Z')
	 * @return  integer
	 */
	 ...
	 *
	 * @param   string   $a  First cell to tests (e.g. 'AA1')
	 * @param   string   $b  Second cell to tests (e.g. 'Z1')
	 * @return  integer
	 */
