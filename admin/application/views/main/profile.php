          ...
          <div class="profile-list">
            <div class="profile-item row">
              ...
              <div class="col-md-7 col-xs-6">
                ...
                <p class="text-muted"><small>建议尺寸200*200</small></p>
              </div>
            ...
            <div class="profile-item row">
              ...
              <div class="col-md-7 col-xs-6">
                ...
                <p class="text-muted"><small>手机用于登录及登录密码的找回、修改，同时接收重要提醒。</small></p>
              </div>
            ...
            <div class="profile-item row">
              ...
              <div class="col-md-7 col-xs-6">
                <p>******</p>
                <p class="text-muted"><small>本密码用于账号登录，登录后可进行所有操作，请妥善保管。</small></p>
              </div>
              <div class="col-md-4 col-xs-4 text-right pull-right">
