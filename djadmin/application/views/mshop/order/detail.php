...
<body>
  ...
  <div id="main">
    <div class="container-fluid">
      <ol class="breadcrumb">
        <li><a href="<?=DJADMIN_URL?>mshop/order/index">外卖订单</a></li>
  ...
  <script id="orderDetailTpl" type="text/html">
    ...
    <dl class="dl-horizontal">
      ...
      <dd>
        ...
        <% } else if(status.code == '2030' ||status.code == '2060' || status.code == '4020' || status.code == '4030' || status.code == '4040' || status.code == '4050' || status.code == '4060') { %>
    ...
    <div class="order-footer-btn">
      ...
      <% } else if(status.code == '2030') { %>
        <a class="btn btn-primary" href="javascript:;" onclick="confirmDelivered('<%:=tid%>')">确认送达</a>
