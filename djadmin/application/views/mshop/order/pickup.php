...
<body>
      ...
      <div class="main-body">
        <div class="main-body-inner">
          <div class="clearfix mb20">
            <div method="get" class="form-inline search-form pull-left">
              ...
              <div class="form-group">
                <div class="form-control-time">
                  <input id="create_time" class="form-control" type="text" name="create_time" placeholder="下单时间" readonly>
              ...
              <div class="form-group">
                <input id="phone" class="form-control" type="text" name="phone" placeholder="取货人手机号" style="width: 130px;">
              </div>
              <div class="form-group">
                <input id="code" class="form-control" type="text" name="code" placeholder="取货码" style="width: 130px;">
              </div>
      ...
      <% for(var i = 0; i < rows.length; i++) { %>
        <tr>
          ...
          <td style="position: relative;">
            <span onMouseOut="onMouseOut(<%:=[i]%>)" onMouseOver="onMouse(<%:=[i]%>)"><%:=rows[i].logistics_code %> / <%:=rows[i].logistics_detail && rows[i].logistics_detail.pick_phone %></span>
            <table class="table hover_table<%:=[i]%>" style="position: absolute;top:60px;display: none;z-index:50;width: 400px;left:0">
              <thead>
                <tr>
                  <th>商品信息</th>
                  <th>商品数量</th>
              ...
              <tbody>
                <% for(var j = 0; j < rows[i].order_ext.length; j++) { %>
                  <tr>
                    <td><%:=rows[i].order_ext[j].goods_title %></td>
                    <td><%:=rows[i].order_ext[j].num %></td>
                  </tr>
                <% } %>
              </tbody>
            </table>
          ...
          <td>
            <%:=(rows[i].logistics_detail && rows[i].logistics_detail.pick_time) ? formatTime(rows[i].logistics_detail.pick_time) : '--' %>
          </td>
          <td>
            ...
            <% } else if(rows[i].status.code == '2030' || rows[i].status.code == '2035' || rows[i].status.code == '2060' || rows[i].status.code == '4020' || rows[i].status.code == '4030' || rows[i].status.code == '4040' || rows[i].status.code == '4050' || rows[i].status.code == '4060') { %>
          ...
          <td>
            <a class="btn-link" href="<?=DJADMIN_URL?>mshop/order/pickup_detail/<%:=rows[i].tid %>">详情</a>
            ...
            <% } else if(rows[i].status.code == '2030' || rows[i].status.code == '2035') { %>
              <a class="btn-link" href="javascript:;" onclick="confirmDelivered('<%:=rows[i].tid %>')">确认取货</a>
  ...
  <?=static_original_url('djadmin/mshop/js/pickup_order_list.min.js');?>
</body>
</html>
