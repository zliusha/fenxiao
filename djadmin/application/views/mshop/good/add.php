...
<body>
  <div id="main">
    ...
    <div class="container-fluid">
      <ol class="breadcrumb">
        <li>
          <a href="<?=DJADMIN_URL?>mshop/items/index">商品管理</a>
        </li>
          ...
          <form id="good-form" class="form-horizontal good-form">
            ...
            <div class="form-group">
              ...
              <div class="col-md-10 col-sm-9">
                <label class="radio-inline">
                  <span class="u-radio">
                    <input type="radio" name="goodMetering" onclick="changeMetering(this)" value="1" checked>
                    <span class="radio-icon"></span>
                  </span>计件
                </label>
                <label class="radio-inline">
                  <span class="u-radio">
                    <input type="radio" name="goodMetering" onclick="changeMetering(this)" value="2">
                    <span class="radio-icon"></span>
                  </span>计重
                </label>
                <select id="count-weight" class="form-control w90 count-weight" name="count_weight" style="display: none" onchange="changeWeightType(this)">
            ...
            <!-- <div class="form-group">
              ...
              <div class="col-md-10 col-sm-9" style="margin-top: 7px">
                <label class="u-switch">
                  <input type="checkbox" name="hide" onclick="changeMember(this)">
            ...
            <div id="only-type-box">
              ...
              <div class="form-group stock-group form-inline">
                <label class="col-md-2 col-sm-3 control-label">
                ...
                <div class="col-md-10 col-sm-9">
                  <label class="radio-inline">
                    <span class="u-radio">
                      <input type="radio" name="goodStock" onclick="changeStockType(this)" value="0" checked>
                      <span class="radio-icon"></span>
                    </span>不限库存
                  </label>
                  <label class="radio-inline">
                    <span class="u-radio">
                      <input type="radio" name="goodStock" onclick="changeStockType(this)" value="1">
                      <span class="radio-icon"></span>
                    </span>自定义库存
                  </label>
                  <input id="good_stock" class="form-control w90 good_stock" type="text" name="good_stock" placeholder="" value="" oninput="if(value.length>9)value=value.slice(0,9)"
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th>餐盒费（元）</th>
                      <th><span class="text-danger">*</span>库存（份）</th>
                      <th></th>
                    </tr>
                  </thead>
            ...
            <div class="form-group clearfix" id="prop" style="display: none;">
              <label class="col-md-2 col-sm-3 control-label">属性：</label>
              <div class="col-md-10 col-sm-9">
                <table class="table">
                  <thead>
        ...
        <div class="modal-body">
          <div class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input id="cate_name" class="form-control" type="text" name="cate_name" placeholder="请输入分类名称">
              </div>
            </div>
            <div class="form-group" style="margin-bottom: 0;">
              <label class="col-md-3 control-label">分类排序：</label>
              <div class="col-md-9">
                <input id="cate_sort" class="form-control" type="number" name="cate_sort" placeholder="请输入分类排序">
              </div>
            </div>
          </div>
        </div>
    ...
    <% if (list.length > 0) { %>
      <% for(var i = 0; i < list.length; i++) { %>
        <tr>
          ...
          <td class="form-group">
            <input class="form-control" type="text" name="good_price" value="<%:=list[i].price %>" oninput="changePrice(this,<%:=i %>)">
          </td>
          <!-- <td class="form-group">
            <input class="form-control good_member" type="text" name="good_member" value="<%:=list[i].member_price %>" oninput="changeMemberPrice(this,<%:=i %>)">
          </td> -->
          <td class="form-group">
            <input class="form-control " type="text" name="good_box" value="<%:=list[i].box %>" oninput="changeBox(this,<%:=i %>)">
          </td>
          <td class="form-group" width="230px">
            <% if (list[i].is_stock) { %>
            <label class="radio-inline">
              <span class="u-radio">
                <input type="radio" name="goodStock<%:=i %>" onclick="changeStockType(this, <%:=i %>)" value="0">
                <span class="radio-icon"></span>
              </span>不限库存
            </label>
            <label class="radio-inline">
              <span class="u-radio">
                <input type="radio" name="goodStock<%:=i %>" onclick="changeStockType(this, <%:=i %>)" value="1" checked>
                <span class="radio-icon"></span>
              </span>自定义库存
            </label><br>
            <%} else {%>
            <label class="radio-inline">
              <span class="u-radio">
                <input type="radio" name="goodStock<%:=i %>" onclick="changeStockType(this, <%:=i %>)" value="0" checked>
                <span class="radio-icon"></span>
              </span>不限库存
            </label>
            <label class="radio-inline">
              <span class="u-radio">
                <input type="radio" name="goodStock<%:=i %>" onclick="changeStockType(this, <%:=i %>)" value="1">
                <span class="radio-icon"></span>
              </span>自定义库存
            </label><br>
            <% } %>  
            <% if (list[i].is_stock) { %>
            <input class="form-control w90 good_stock" type="text" name="good_stock" value="<%:=list[i].stock %>" oninput="changeStock(this,<%:=i %>)" style="margin-top:6px">
            <%} else {%>
            <input class="form-control w90 good_stock" type="text" name="good_stock" value="<%:=list[i].stock %>" oninput="changeStock(this,<%:=i %>)" style="display: none;margin-top:6px">
            <% } %>  
          </td>
          <td class="form-group">
  ...
  <?=static_original_url('djadmin/mshop/js/good.js');?>
</body>
</html>