          ...
          <form id="good-form" class="form-horizontal good-form">
            ...
            <div class="form-group">
              ...
              <div class="col-md-10 col-sm-9">
                <label class="radio-inline">
                  <span class="u-radio">
                    <input type="radio" name="goodMetering" value="1" onclick="changeMetering(this)" checked disabled>
                    <span class="radio-icon"></span>
                  </span>计件
                </label>
                <label class="radio-inline">
                  <span class="u-radio">
                    <input type="radio" name="goodMetering" value="2" onclick="changeMetering(this)" disabled>
                    <span class="radio-icon"></span>
                  </span>计重
                </label>
