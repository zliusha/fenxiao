...
<body>
  ...
  <script id="xcxTpl" type="text/html">
    ...
    <% if (use_status == 1) { %>
      <div class="xcx-block">
        <h3 class="xcx-title">请先点击下方按钮生成小程序。</h3>
    ...
    <% if (!!info) { %>
      <div class="xcx-block">
        ...
        <p class="xcx-desc">正常情况下，请不要轻易修改小程序对应微信支付的商户号和商户密钥，配置不正确将导致小程序微信支付异常</p>
  ...
  <?= static_original_url('djadmin/mshop/js/xcx.min.js'); ?>
</body>
</html>
