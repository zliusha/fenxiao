...
<body>
<input id="active_id" type="hidden" value="<?=$active_id?>">
<div id="main">
        ...
        <form id="discount-form" class="form-horizontal m-form-horizontal">
          <div class="form-group">
            ...
            <div class="col-md-10 col-sm-9">
              <select id="shop" class="form-control w360" name="shop_id" disabled>
          ...
          <div class="form-group form-inline">
            ...
            <div class="col-md-10 col-sm-9" style="position: relative">
              <input size="16" id="start_time" type="text" value="" disabled readonly class="form_datetime form-control" style="width: 170px" name="start_time">
              <label>至</label>
