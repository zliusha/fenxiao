...
<body>
      ...
      <div class="main-body">
        <div class="main-body-inner">
          ...
          <div id="couponView">
            ...
            <p><a class="btn btn-primary" href="<?=DJADMIN_URL?>mshop/promotion/coupon_record?coupon_type=2">领取记录</a></p>
            <div style="color: #c0ccda;">您可以设置赠送给新顾客的优惠券，在新顾客关注您的公众号时，获得优惠券促成消费。</div>
            <hr>
          </div>
          <form id="coupon-form" class="form-horizontal m-form-horizontal" style="display: none">
            ...
            <div class="form-group form-inline" style="">
              ...
              <div class="col-md-10 col-sm-9" >
                <input size="16" id="changeFrom" type="text" style="background-color: transparent" readonly class="form_datetime form-control" name="changeFrom">
                <label>至</label>
                <input size="16" id="changeTo" type="text" style="background-color: transparent" readonly class="form_datetime form-control" name="changeTo">
              </div>
            </div>
            <div class="form-group form-inline" style="">
            ...
            <div class="form-group" >
              ...
              <div class="col-md-10 col-sm-9">
                <div class="form-control-time " style="width: 365px">
                  <input id="discount_name" type="text" name="discount_name" class="from form-control" placeholder="限制10个汉字" >
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-10 col-sm-9">
                ...
                <div class="clearfix">
                  ...
                  <div class="input-group pull-left ml20" style="width: 125px;">
                    <input id="minPrice" class="form-control" type="text" name="minPrice">
                    <span class="input-group-addon">元</span>
                  </div>
                  <div class="input-group pull-left ml10 mr10" style="line-height: 28px;">-</div>
            ...
            <div class="form-group form-inline" >
              ...
              <div class="col-md-10 col-sm-9">
                <input size="16" id="accountFrom" type="text" readonly style="background-color: transparent" class="form_datetime form-control" name="accountFrom">
                <label>至</label>
                <input size="16" id="accountTo" type="text" readonly style="background-color: transparent"  class="form_datetime form-control" name="accountTo">
  ...
  <script id="activeTpl" type="text/html">
    <% if (list.length > 0) { %>
      <% for(var i = 0; i < list.length; i++) { %>
        <div class="form-group form-inline clearfix" style="width: 600px">
          <label class="control-label pull-left">活动状态：</label>
          <div class="pull-left">
            <span id="active_status"><%:=list[i].status %></span>
          </div>
        </div>
        <div class="form-group form-inline clearfix" style="width: 600px">
          <label class="control-label pull-left">活动时间：</label>
          <div class="pull-left">
            <span class="fromTime"><%:=list[i].fromTime %></span>至<span class="toTime"><%:=list[i].toTime %></span>
          </div>
        </div>
        <div class="form-group form-inline clearfix" >
          <label class="control-label pull-left">&nbsp;&nbsp;&nbsp;优惠券：</label>
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th>库存(张)</th>
                  <th>规则</th>
                  <th class="lastMake">操作</th>
                </tr>
              </thead>
              <tbody class="activeTbody">
                <tr>
        ...
        <div class="form-group clearfix" style="width: 600px">
          <div style="margin:-20px 0 0 70px;">
            <a class="btn btn-default" onclick="editActive()">编辑</a>
            <a id="endActive" class="btn btn-primary ml10" onclick="endActive(this,'0','4')">结束活动</a>
            <a id="delActive" class="btn btn-default ml10" onclick="delActive()" style="display: none">删除</a>
          </div>
        </div>
      <% } %>
  ...
  <?=static_original_url('djadmin/mshop/js/coupon_follow.min.js'); ?>
</body>
</html>
