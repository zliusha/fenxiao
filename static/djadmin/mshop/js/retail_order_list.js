...
$(function () {
  ...
  function getOrderList(curr) {
    $.getJSON(
      __BASEURL__ + "mshop/statements_api/record_list", {
        current_page: curr || 1,
        page_size: page_size,
        shop_id: shop_id,
        time: create_time,
  ...
  function exportOrder() {
    var url = __BASEURL__ + 'mshop/statements_api/export?shop_id=' + shop_id + '&current_page=1&page_size=9999' + '&serial_number=' + serialNumber + '&time=' + create_time + '&source_type=3';
    window.open(url);
  }
