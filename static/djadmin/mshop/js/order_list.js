...
$(function () {
  ...
  function exportOrder() {
    var url = __BASEURL__ + 'mshop/order_api/export_wm?shop_id=' + shop_id + '&current_page=1&page_size=9999' + '&status=' + status + '&create_time=' + create_time + '&tradeno=' + tradeno + '&name=' + name + '&phone=' + phone;
    window.open(url);
  }
