...
$(function () {
  ...
  // 获取商城设置信息
  function getXcxInfo() {
    $.getJSON(__BASEURL__ + "mshop/xcx_meal_config_api/info", function (data) {
      if (data.success) {
        if (!data.data) {
          return
        }
  ...
  $btnConfirmGenerate.on("click", function () {
    ...
    $.getJSON(__BASEURL__ + 'mshop/xcx_meal_config_api/generate', function (data) {
      if (data.success) {
        new Msg({
          type: "success",
          msg: data.msg,
  ...
  function experienceXcx() {
    ...
    $.getJSON(__BASEURL__ + 'mshop/xcx_meal_config_api/getqrcode', function (data) {
      if (data.success) {
  ...
  function initVerifyForm() {
    ...
    .on('success.form.bv', function (e) {
      ...
      $.post(__BASEURL__ + 'mshop/xcx_meal_config_api/save_verify_file', autoCsrf({
        app_id: app_id,
